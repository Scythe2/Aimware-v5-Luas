...
gui.Command(clear)
scriptlist.log("###################################");
scriptlist.log("EngineRadar......... -> MISC|Bypass");
scriptlist.log("ShowImpacts......... -> MISC|Bypass");
scriptlist.log("Fullbright.......... -> MISC|Bypass");
scriptlist.log("Lagcompensation..... -> MISC|Bypass");
scriptlist.log("Postprocess......... -> MISC|Bypass");
scriptlist.log("DisableWorldShadows. -> MISC|Bypass");
scriptlist.log("ZeusRangeIndicator.. -> MISC|Bypass");
scriptlist.log("ColoCorrection...... -> MISC|Bypass");
scriptlist.log("###################################");
