...
function RainbowGunESP()
	...
	gui.SetValue( "esp.chams.weapon.visible", math.floor(R), math.floor(G), math.floor(B),255)
	gui.SetValue( "esp.chams.weapon.overlay", math.floor(R), math.floor(G), math.floor(B),255)
end

callbacks.Register( "Draw", "RGE", RainbowGunESP);